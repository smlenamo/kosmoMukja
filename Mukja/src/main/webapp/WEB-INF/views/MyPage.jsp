...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<c:url value='/resources/bootstrap/button/style.css'/>">
    <link rel="stylesheet" href="<c:url value='/resources/bootstrap/button/normalize.css'/>">
    <link rel="stylesheet" href="<c:url value='/resources/bootstrap/button/demo.css'/>">
    <link rel="stylesheet" href="<c:url value='/resources/bootstrap/button/common.css'/>">
  </head>
  <body>
